      ...
      <div className="container relative grid min-h-[calc(100vh-4rem)] items-center gap-12 lg:grid-cols-1">
        <div className="flex flex-col items-center gap-8 text-center">
          ...
          <a href="#cta">
            <Button
              size="lg"
              className="h-14 animate-pulando-lento rounded-md bg-gradient-to-r from-primary to-accent px-10 py-4 font-headline text-lg font-bold text-primary-foreground transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-accent/20"
            >
